...
define('ember-app/mixins/regenerated/models/i-i-s-gladkov-kursovaya-\u0447\u0435\u0440\u0442\u0435\u0436\u0438', ['exports', 'ember-data', 'ember-cp-validations', 'ember-flexberry-data/utils/attributes'], function (exports, _emberData, _emberCpValidations, _attributes) {
  ...
  var defineProjections = exports.defineProjections = function defineProjections(modelClass) {
    ...
    modelClass.defineProjection('ЧертежиL', 'i-i-s-gladkov-kursovaya-чертежи', {
      номерЧертежа: (0, _attributes.attr)('Номер чертежа', { index: 0 }),
      датаСоздания: (0, _attributes.attr)('Дата создания', { index: 1 }),
      заявки: (0, _attributes.belongsTo)('i-i-s-gladkov-kursovaya-заявки', 'Деталь', {
        наименДетали: (0, _attributes.attr)('Деталь', { index: 2 })
      }, { index: -1, hidden: true }),
      утверждение: (0, _attributes.attr)('Утверждение', { index: 3 })
    });
  };
});
